...
- (void) awakeFromNib	{
	...
	[myIPField setStringValue:(addressArray!=nil && [addressArray count]>0) ? [addressArray objectAtIndex:0] : [NSString stringWithFormat:@"127.0.0.1"]];
	...
	NSString		*tmpLabel = [NSString stringWithFormat:@"ManualOutput"];
